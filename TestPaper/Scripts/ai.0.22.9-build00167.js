...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        var _InternalLogging = (function () {
                ...
                if (this.enableDebugExceptions()) {
                    ...
                    if (typeof (message) !== "undefined" && !!message) {
                        if (typeof (message.message) !== "undefined") {
                            ...
                            this.UsersternalMessage(severity, message);
                        }
                    }
                }
            };
            ...
            _InternalLogging.UsersternalMessage = function (severity, message) {
        ...
        var Initialization = (function () {
            ...
            Initialization.prototype.pollInteralLogs = function (appInsightsInstance) {
                return setInterval(function () {
                    ...
                    queue.length = 0;
                }, this.config.diagnosticUsersterval);
            };
            ...
            Initialization.getDefaultConfig = function (config) {
                ...
                config.maxBatchInterval = !isNaN(config.maxBatchInterval) ? config.maxBatchInterval : 13000;
                ...
                config.diagnosticUsersterval = config.diagnosticUsersterval || 10000;
